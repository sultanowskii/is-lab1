...
@Component
public class ImportLogSpecification {
    ...
    public Specification<ImportLog> build(User user) throws ValidationException {
        if (user.isAdmin()) {
            return null;
        }
    ...
    public Specification<ImportLog> buildWithSearchParams(User user, SearchParamsDto searchParamsDto) throws ValidationException {
        if (user.isAdmin()) {
    ...
    public Specification<ImportLog> withFieldContaining(String fieldName, String substring) throws ValidationException {
